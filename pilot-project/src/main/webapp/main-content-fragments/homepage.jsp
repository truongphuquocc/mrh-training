				...
				<form action="">
					<div class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
						...
						<div
							...
							style="display: block;">
							<a class="btn btn-primary btn-filter-close">Bỏ chọn</a> <a
								class="btn btn-danger btn-filter-readmore">Xem <b
			...
			<div class="dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
					...
					<form class="range-price">
						<div class="display ">
							<span class=" text-center btn-dropdown min"></span> <span
								class=" text-center btn-dropdown max"></span>
						</div>
					</form>
					<div class="range-slide">
						<div class="slide">
						...
						<input class="priceFrom2" type="range" max="42000000" min="300000"
							step="100000" value="1000000">
						<input class="priceTo2"
