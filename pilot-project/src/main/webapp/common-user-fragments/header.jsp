...
<header>
	<div class="container">
		<div class="row" style="position: relative;">
			<div class="col-lg-12">
				<div class="left-area float-left d-flex row">
					<div class="logo">
				...
				<div class="right-area float-right">
					<a href="#" class="refer-link active">Kinh nghiệm hay 
						<span>&amp; Tin khuyến mãi 
							<label class="arr-down"></label>
						</span>
					</a>
					 <a href="#" class="refer-link">1800.1061 
					 	<span>&amp; Tổng đài miễn phí </span>
					 </a>
					<a href="#" class="refer-link one-line cart">
						<i class="fas fa-shopping-cart"></i>
					</a>
					<a href="#" class="refer-link one-line history">Lịch sử mua hàng</a>
				</div>
